...
En el modelo de remuneración \textit{pro-rata}, los ingresos por suscripciones se agregan a una bolsa común y luego se distribuyen proporcionalmente al total de \textit{streams} de cada artista, como explica \citeA{LEI2023111111}. En términos simplificados, si $S_i$ son los \textit{streams} del artista $i$ y $\sum_j S_j$ es el total de reproducciones (de toda la plataforma), entonces la fracción de pago para el artista es:
